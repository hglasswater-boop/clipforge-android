...
/**
 * Converts actual per-phase work into a monotonic overall progress value and a smoothed ETA.
 *
 * The phase ranges deliberately reflect the expensive work in [AutoTrimAnalyzer]: scene decoding,
 * audio decoding and visual frame extraction account for almost all of the budget. No timer-based
 * fake progress is used. ETA is shown only after enough real work has completed to avoid a noisy
 * estimate during startup.
 */
